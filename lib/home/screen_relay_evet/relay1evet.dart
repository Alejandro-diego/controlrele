...
class Relay1Event extends StatefulWidget {
  const Relay1Event({Key? key}) : super(key: key);

  @override
  State<Relay1Event> createState() => _Relay1EventState();
}

class _Relay1EventState extends State<Relay1Event> {
